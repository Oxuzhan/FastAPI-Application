import sys
import os
# amaç aslında tüm id leri çekmek istediğimiz kadar çekebiliriz
sys.path.append('/Users/oguzhanatmaca/Desktop/entrapeer/task2')  


from tasks import fetch_company_data, analyze_data

# Şirket ID'lerini listele
company_ids = [
    ...
    # Buraya tüm diğer şirket ID'lerini ekle
]

# Şirket verilerini paralel olarak çek
for company_id in company_ids:
    fetch_company_data.delay(company_id)

# Verileri analiz et (analiz görevi, tüm veriler çekildikten sonra çalıştırılmalı)
analyze_data.delay()
